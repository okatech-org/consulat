...
-- CreateEnum
CREATE TYPE "RequestStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED', 'CANCELLED', 'INCOMPLETE', 'IN_PROGRESS', 'COMPLETED', 'VALID', 'DRAFT', 'SUBMITTED', 'REVIEW', 'ADDITIONAL_INFO_NEEDED', 'VALIDATED');
