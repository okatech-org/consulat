...
- [ ] Estimer gain : **60-70% de réduction du temps de chargement**

#### ✅ Optimisation des requêtes
- [ ] Créer des requêtes dédiées pour le dashboard avec seulement les champs nécessaires
- [ ] Limiter les résultats (ex: 5 dernières demandes, 3 prochains RDV)
- [ ] Utiliser `select` dans Prisma pour ne récupérer que les champs affichés
