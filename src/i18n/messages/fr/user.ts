export default {
  ...
  children: {
    ...
    form: {
      identity_section: 'Informations personnelles',
      birth_nationality_section: 'Naissance et nationalité',
      parental_section: 'Lien parental',
      first_name: 'Prénom',
      last_name: 'Nom',
      gender: 'Genre',
      ...
      parent_role: 'Votre lien de parenté',
      parent_role_description: "Précisez votre lien avec l'enfant",
      select_role: 'Choisir un lien',
      father: 'Père',
      mother: 'Mère',
