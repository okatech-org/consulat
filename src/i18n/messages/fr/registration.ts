export default {
  ...
  steps: {
    ...
    basicInfo: 'Identité',
    basicInfo_description: 'Informations personnelles',
    familyInfo: 'Famille',
    familyInfo_description: 'Situation familiale',
    contactInfo: 'Contact',
    contactInfo_description: 'Coordonnées',
    professionalInfo: 'Professionnel',
    professionalInfo_description: 'Situation professionnelle',
    review: 'Révision',
