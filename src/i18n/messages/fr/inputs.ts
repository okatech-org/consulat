export default {
  ...
  pdfEditor: {
    ...
    style: {
      ...
      'flexDirection.row-reverse': 'Ligne inversée',
      'flexDirection.column-reverse': 'Colonne inversée',
      justifyContent: 'Justification',
      justifyContent_placeholder: 'Justification',
      'justifyContent.flex-start': 'Début',
      'justifyContent.flex-end': 'Fin',
      'justifyContent.center': 'Centré',
      'justifyContent.space-between': 'Espacé',
      'justifyContent.space-around': 'Autour',
      alignItems: 'Alignement vertical',
      alignItems_placeholder: 'Alignement',
      'alignItems.flex-start': 'Début',
      'alignItems.flex-end': 'Fin',
      'alignItems.center': 'Centré',
      'alignItems.stretch': 'Étiré',
      'alignItems.baseline': 'Ligne de base',
      flex: 'Flex',
      flex_placeholder: 'Ex: 1',
      flexWrap: 'Retour à la ligne',
      flexWrap_placeholder: 'wrap/nowrap',
      'flexWrap.nowrap': 'Pas de retour',
      'flexWrap.wrap': 'Retour',
      'flexWrap.wrap-reverse': 'Retour inversé',
      alignSelf: 'Alignement individuel',
      alignSelf_placeholder: 'Alignement',
      'alignSelf.auto': 'Auto',
      'alignSelf.flex-start': 'Début',
      'alignSelf.flex-end': 'Fin',
      'alignSelf.center': 'Centré',
      'alignSelf.stretch': 'Étiré',
      'alignSelf.baseline': 'Ligne de base',
      gap: 'Espacement',
      gap_placeholder: 'Ex: 8',
      position: 'Position',
      position_placeholder: 'relative/absolute',
      'position.absolute': 'Absolue',
      'position.relative': 'Relative',
      top: 'Haut',
      right: 'Droite',
      bottom: 'Bas',
      left: 'Gauche',
      zIndex: 'Ordre (z-index)',
      overflow: 'Débordement',
      overflow_placeholder: 'visible/hidden',
      'overflow.visible': 'Visible',
      'overflow.hidden': 'Caché',
      'overflow.scroll': 'Défilement',
      display: 'Affichage',
      display_placeholder: 'flex/none',
      'display.flex': 'Flex',
      'display.none': 'Aucun',
      width: 'Largeur',
      width_placeholder: 'Ex: 100%',
      ...
      borderRadius: 'Rayon bordure',
      borderTopLeftRadius: 'Rayon coin haut gauche',
      borderTopRightRadius: 'Rayon coin haut droit',
      borderBottomLeftRadius: 'Rayon coin bas gauche',
      borderBottomRightRadius: 'Rayon coin bas droit',
      transform: 'Transformation',
      transformOrigin: 'Origine transformation',
      objectFit: 'Ajustement image',
      objectFit_placeholder: 'cover/contain...',
      'objectFit.cover': 'Couvrir',
      'objectFit.contain': 'Contenir',
      'objectFit.fill': 'Remplir',
      'objectFit.none': 'Aucun',
      'objectFit.scale-down': 'Réduire',
      objectPosition: 'Position image',
    },
  },
  actions: {
    save: 'Sauvegarder',
