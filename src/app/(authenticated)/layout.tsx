  ...
  return (
    <SidebarProvider>
      ...
      <SidebarInset className="overflow-hidden w-full flex flex-col relative pb-safe pt-16">
        <header className="w-full fixed left-0 right-0 top-0 px-4 z-50 h-16 bg-card shrink-0 border-b border-border items-center gap-2 transition-[width,height] ease-linear">
