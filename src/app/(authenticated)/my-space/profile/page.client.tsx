...
export default function ProfilePageClient({ searchParams }: ProfilePageClientProps = {}) {
  ...
  const { data: availableCountries } = api.countries.getActive.useQuery(undefined, {
    enabled: !!searchParams?.form,
  });
  ...
  // Afficher le formulaire de registration si demandé
  if (searchParams?.form && availableCountries && profile) {
