...
import { ArrowRight, Calendar, CheckCircle, Clock, FileText, User } from 'lucide-react';
  ...
  return (
    <div className="container space-y-8 py-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <Button asChild>
          <Link href={ROUTES.user.profile}>{t_profile('actions.complete_profile')}</Link>
        </Button>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-1">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Button variant="ghost" size="sm" asChild>
              <Link href={ROUTES.user.appointments}>{t_profile('actions.see_all')}</Link>
            </Button>
          </CardHeader>
          <CardContent className="space-y-4">
