...
import { FormNavigation } from '@/app/(authenticated)/services/_utils/consular-services/service-form/form-navigation'
              ...
              {profilDocuments && Object.keys(profilDocuments).map((key) => (
                ...
                >
                  <DocumentStatus
                    ...
                    customText={t('components.status.already_provided')}
                  />
                  <Separator />
                </motion.div>
              ))
