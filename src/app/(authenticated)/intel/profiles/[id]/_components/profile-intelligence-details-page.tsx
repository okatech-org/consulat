...
import { ArrowLeft, User, Calendar, Shield, FileText, Eye, MapPin, Clock, Plus } from 'lucide-react';
  ...
  if (!profile) {
    return (
      <div className="max-w-md mx-auto px-4 text-center py-16">
          <h2 className="text-3xl font-bold mb-4" style={{ color: 'var(--text-primary)' }}>Profil non trouvé</h2>
      ...
      <div className="space-y-6">
          ...
          >
            ...
            <div
              ...
              style={{
                width: '100px',
                background: 'linear-gradient(90deg, transparent, var(--accent-intel) 50%, transparent)',
            ...
            <div className="relative z-10">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 mb-6">
                ...
                <div className="flex items-center gap-4 flex-1 min-w-0">
                  <Avatar className="h-16 w-16 sm:h-20 sm:w-20 border-4 shadow-xl flex-shrink-0" style={{ borderColor: 'var(--border-glass-secondary)' }}>
                    <AvatarImage 
                      src={profile.identityPicture?.fileUrl || '/avatar-placeholder.png'} 
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6 mt-6">
                {profile.birthDate && (
                  ...
                  >
                    <Calendar className="h-5 w-5 flex-shrink-0" style={{ color: 'var(--text-muted)' }} />
                    <div className="min-w-0 flex-1">
                      <p className="text-xs font-medium" style={{ color: 'var(--text-muted)' }}>Date de naissance</p>
                ...
                {profile.birthPlace && (
                  ...
                  >
                    <MapPin className="h-5 w-5 flex-shrink-0" style={{ color: 'var(--text-muted)' }} />
                    <div className="min-w-0 flex-1">
                      <p className="text-xs font-medium" style={{ color: 'var(--text-muted)' }}>Lieu de naissance</p>
                      <p className="font-semibold text-sm" style={{ color: 'var(--text-primary)' }}>{profile.birthPlace}</p>
                    </div>
                  </div>
                )}
                ...
                >
                  <Clock className="h-5 w-5 flex-shrink-0" style={{ color: 'var(--text-muted)' }} />
                  <div className="min-w-0 flex-1">
                    <p className="text-xs font-medium" style={{ color: 'var(--text-muted)' }}>Dernière activité</p>
                    <p className="font-semibold text-sm" style={{ color: 'var(--text-primary)' }}>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-6">
            ...
            <div className="lg:col-span-2">
              ...
              >
                ...
                <div className="px-6 pt-5 pb-4 border-b flex-shrink-0" style={{ borderColor: 'var(--border-glass-secondary)' }}>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        const event = new CustomEvent('addIntelligenceNote', { detail: { profileId } });
            ...
            <div>
              ...
              >
                {/* Header compact */}
                <div className="px-6 pt-5 pb-4 border-b flex-shrink-0" style={{ borderColor: 'var(--border-glass-secondary)' }}>
                  <h3 className="text-lg font-bold" style={{ color: 'var(--text-primary)' }}>Actions Prioritaires</h3>
                </div>
                <CardContent className="p-6 space-y-5 flex flex-col flex-1 overflow-hidden">
                  {/* Actions Rapides */}
                  <div className="space-y-4">
                    <h4 className="font-bold text-sm uppercase tracking-wider" style={{ color: 'var(--text-primary)' }}>Actions Rapides</h4>
                  ...
                  <div className="space-y-4 flex-shrink-0">
                    <h5 className="font-bold text-xs uppercase tracking-wider" style={{ color: 'var(--text-primary)' }}>Statistiques</h5>
                    ...
                    >
                      <div className="flex justify-between items-center">
                        <span className="text-xs font-medium" style={{ color: 'var(--text-muted)' }}>Âge</span>
                        <span className="text-xs font-mono font-bold" style={{ color: 'var(--text-primary)' }}>
                          {profile.birthDate ? `${new Date().getFullYear() - new Date(profile.birthDate).getFullYear()} ans` : 'N/A'}
                        </span>
                      </div>
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-xs font-medium" style={{ color: 'var(--text-muted)' }}>Surveillance</span>
