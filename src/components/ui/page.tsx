...
import { ArrowRight, Check, Globe, Lock, FileText, Users, MessageSquare, Shield, ExternalLink, Building2, GraduationCap } from 'lucide-react';
...
import { MobileSectionCarousel } from '@/components/home/mobile-section-carousel';
...
export default async function LandingPage() {
  ...
  const videoParticipation = getYoutubeEmbedUrl("https://www.youtube.com/watch?v=dQw4w9WgXcQ");
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
              ...
              <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
                <Link 
                  ...
                  className={buttonVariants({ 
                    size: "lg", 
                    className: "gap-2 bg-blue-700 hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-500 text-white home-button-primary"
                  })}
                >
            ...
            <Link
              ...
              className={buttonVariants({
                    size: "lg", 
                    variant: "outline", 
                    className: "gap-2 border-blue-300 bg-white hover:bg-gray-50 text-blue-700 dark:border-blue-700 dark:bg-gray-900 dark:hover:bg-gray-800 dark:text-blue-400 home-button-secondary"
                  })}
                >
            ...
            <AnimatedSection animation="fade-left" className="flex justify-center">
              <div>
                <div>
                  <h3 className="text-xl font-bold text-blue-700 dark:text-blue-500 mb-4">Consulat Digital</h3>
        ...
        <div className="container relative mx-auto px-4 sm:px-6 lg:px-8 max-w-screen-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
                  ...
                  <a href="#" aria-label="Twitter" className="group">
                    <div className="relative flex items-center justify-center">
                      ...
                      <div className="relative bg-white dark:bg-gray-800 rounded-full p-2.5 shadow-sm transition-all duration-300 group-hover:shadow-md group-hover:shadow-blue-500/10 dark:group-hover:shadow-blue-500/5">
                        <svg className="h-5 w-5 text-gray-600 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  <a href="#" aria-label="Instagram" className="group">
                    <div className="relative flex items-center justify-center">
                      ...
                      <div className="relative bg-white dark:bg-gray-800 rounded-full p-2.5 shadow-sm transition-all duration-300 group-hover:shadow-md group-hover:shadow-purple-500/10 dark:group-hover:shadow-purple-500/5">
                        <svg className="h-5 w-5 text-gray-600 dark:text-gray-300 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="mx-auto md:ml-auto md:mr-0 max-w-md w-full">
              <AnimatedSection animation="fade-up" delay={0.2} className="relative group bg-gradient-to-br from-white to-gray-50 dark:from-[#242424] dark:to-[#2F2F2F] rounded-lg p-5 sm:p-6 shadow-lg shadow-blue-500/5 dark:shadow-blue-500/2 border border-gray-100 dark:border-gray-800">
          ...
          <AnimatedSection animation="fade-up" delay={0.3} className="mt-6 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex flex-wrap justify-center md:justify-end gap-6">
              <Link href="/legal/privacy" className="group relative text-xs md:text-sm text-gray-500 dark:text-gray-400 transition-colors duration-300 hover:text-blue-600 dark:hover:text-blue-400">
              ...
              <Link href="/legal/terms" className="group relative text-xs md:text-sm text-gray-500 dark:text-gray-400 transition-colors duration-300 hover:text-blue-600 dark:hover:text-blue-400">
                <span>Conditions d'utilisation</span>
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-blue-500 opacity-0 group-hover:w-full group-hover:opacity-100 transition-all duration-300"></span>
              </Link>
              <Link href="/legal/mentions" className="group relative text-xs md:text-sm text-gray-500 dark:text-gray-400 transition-colors duration-300 hover:text-blue-600 dark:hover:text-blue-400">
