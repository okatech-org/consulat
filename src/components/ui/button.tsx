  ...
  ].join(' '),
  {
    variants: {
      variant: {
        ...
        destructiveOutline:
          'border border-destructive text-destructive bg-transparent shadow-interactive hover:shadow-interactive-hover active:shadow-interactive-active hover:bg-destructive/10',
        outline:
