    ...
    >
      ...
      <style jsx>{`
        ...
        .refraction-layer {
          ...
          border-radius: 50%;
          background: radial-gradient(
            circle at calc(50% + ${mousePosition.x * 30}px)
        ...
        @keyframes refraction-shift {
          0%,
          100% {
            transform: translateZ(8px) scale(1) rotate(0deg);
            opacity: 0.5;
          }
          50% {
            transform: translateZ(8px) scale(1.05) rotate(10deg);
            opacity: 0.7;
          }
        }
        ...
        @keyframes orbit-close {
          0% {
            transform: translateZ(30px) rotate(0deg) translateX(20px) rotate(0deg);
          }
          100% {
            transform: translateZ(30px) rotate(360deg) translateX(20px) rotate(-360deg);
          }
        }
        ...
        @keyframes wave-emission-3d {
          0% {
            transform: scale3d(0.9, 0.9, 1) translateZ(0px);
            opacity: 0.5;
          }
          50% {
            transform: scale3d(1.5, 1.5, 1.2) translateZ(5px);
            opacity: 0;
          }
          100% {
            transform: scale3d(1.8, 1.8, 1.4) translateZ(10px);
            opacity: 0;
          }
        }
        ...
        @keyframes core-pulse-3d-heartbeat {
          ...
          65% {
            transform: translateZ(28px) scale3d(1, 1, 1) rotate(65deg);
            filter: brightness(1);
        ...
        @keyframes orbital-rotation-1-3d {
          0% {
            transform: translateZ(10px) rotateZ(0deg) rotateX(60deg) rotateY(0deg);
          }
          100% {
            transform: translateZ(10px) rotateZ(360deg) rotateX(60deg) rotateY(0deg);
          }
        }

        @keyframes orbital-rotation-2-3d {
          0% {
            transform: translateZ(5px) rotateZ(0deg) rotateX(0deg) rotateY(60deg);
          }
          100% {
            transform: translateZ(5px) rotateZ(360deg) rotateX(0deg) rotateY(60deg);
          }
        }

        @keyframes orbital-rotation-3-3d {
          0% {
            transform: translateZ(15px) rotateZ(90deg) rotateX(30deg) rotateY(30deg);
          }
          100% {
            transform: translateZ(15px) rotateZ(450deg) rotateX(30deg) rotateY(30deg);
          }
        }
        ...
        @keyframes particle-orbit-3d-dynamic {
          0% {
            transform: rotateZ(var(--start-deg)) translateX(var(--orbit-radius))
              translateZ(var(--z-offset)) scale3d(0.8, 0.8, 1);
            opacity: 0.4;
            filter: hue-rotate(0deg) brightness(1);
            box-shadow:
              0 0 var(--glow-size) var(--color),
              0 0 calc(var(--glow-size) * 2) var(--color-transparent);
          }
          25% {
            transform: rotateZ(calc(var(--start-deg) + 90deg))
              translateX(calc(var(--orbit-radius) + 5px))
              translateZ(calc(var(--z-offset) + 8px)) scale3d(1.3, 1.3, 1.5);
            opacity: 1;
            filter: hue-rotate(90deg) brightness(1.3);
            box-shadow:
              0 0 calc(var(--glow-size) * 2) var(--color),
              0 0 calc(var(--glow-size) * 4) var(--color-transparent);
          }
          50% {
            transform: rotateZ(calc(var(--start-deg) + 180deg))
              translateX(var(--orbit-radius)) translateZ(var(--z-offset))
              scale3d(0.6, 0.6, 0.8);
            opacity: 0.3;
            filter: hue-rotate(180deg) brightness(0.9);
            box-shadow:
              0 0 var(--glow-size) var(--color),
              0 0 calc(var(--glow-size) * 1.5) var(--color-transparent);
          }
          75% {
            transform: rotateZ(calc(var(--start-deg) + 270deg))
              translateX(calc(var(--orbit-radius) + 8px))
              translateZ(calc(var(--z-offset) - 5px)) scale3d(1.4, 1.4, 1.7);
            opacity: 1;
            filter: hue-rotate(270deg) brightness(1.5);
            box-shadow:
              0 0 calc(var(--glow-size) * 2.5) var(--color),
              0 0 calc(var(--glow-size) * 5) var(--color-transparent);
          }
          100% {
            transform: rotateZ(calc(var(--start-deg) + 360deg))
              translateX(var(--orbit-radius)) translateZ(var(--z-offset))
              scale3d(0.8, 0.8, 1);
            opacity: 0.4;
            filter: hue-rotate(360deg) brightness(1);
        ...
        .neuromorphic-surface {
          background: radial-gradient(
            circle at calc(50% + ${mousePosition.x * 20}px)
        ...
        .neuromorphic-membrane {
          border-radius: 50%;
          background: radial-gradient(
            circle at calc(50% + ${mousePosition.x * 40}px)
              calc(50% + ${mousePosition.y * 40}px),
        ...
        .living-matter {
          animation:
            living-matter-float 10s ease-in-out infinite alternate,
        ...
        @keyframes vortex-spin-1 {
          ...
          100% {
            transform: translateZ(8px) rotate(360deg);
            opacity: 0.2;
          }
        }
        ...
        @keyframes nucleus-orbit {
          ...
          33% {
            transform: translateX(3px) translateY(1px) rotate(120deg);
          }
          66% {
            transform: translateX(-1px) translateY(3px) rotate(240deg);
          }
          100% {
            transform: translateX(2px) translateY(-3px) rotate(360deg);
          }
        }
