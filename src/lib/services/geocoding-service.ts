...
const CITY_COORDINATES: Record<string, CityCoordinates> = {
  ...
  'noisy le grand': { latitude: 48.8485, longitude: 2.5514, country: 'France', region: 'Île-de-France' },
  'noisy-le-grand': { latitude: 48.8485, longitude: 2.5514, country: 'France', region: 'Île-de-France' },
  'metz': { latitude: 49.1193, longitude: 6.1757, country: 'France', region: 'Grand Est' },
  'nancy': { latitude: 48.6921, longitude: 6.1844, country: 'France', region: 'Grand Est' },
  'rouen': { latitude: 49.4432, longitude: 1.0999, country: 'France', region: 'Normandie' },
  'angers': { latitude: 47.4784, longitude: -0.5632, country: 'France', region: 'Pays de la Loire' },
  'poitiers': { latitude: 46.5802, longitude: 0.3404, country: 'France', region: 'Nouvelle-Aquitaine' },
  'limoges': { latitude: 45.8336, longitude: 1.2611, country: 'France', region: 'Nouvelle-Aquitaine' },
  'tours': { latitude: 47.3941, longitude: 0.6848, country: 'France', region: 'Centre-Val de Loire' },
  'orleans': { latitude: 47.9029, longitude: 1.9039, country: 'France', region: 'Centre-Val de Loire' },
  'orléans': { latitude: 47.9029, longitude: 1.9039, country: 'France', region: 'Centre-Val de Loire' },
  'pau': { latitude: 43.2951, longitude: -0.3708, country: 'France', region: 'Nouvelle-Aquitaine' },
  'bayonne': { latitude: 43.4945, longitude: -1.4748, country: 'France', region: 'Nouvelle-Aquitaine' },
  'perpignan': { latitude: 42.6886, longitude: 2.8948, country: 'France', region: 'Occitanie' },
  'avignon': { latitude: 43.9493, longitude: 4.8055, country: 'France', region: 'PACA' },
  'aix-en-provence': { latitude: 43.5297, longitude: 5.4474, country: 'France', region: 'PACA' },
  'aix en provence': { latitude: 43.5297, longitude: 5.4474, country: 'France', region: 'PACA' },
  'besançon': { latitude: 47.2378, longitude: 6.0241, country: 'France', region: 'Bourgogne-Franche-Comté' },
  'besancon': { latitude: 47.2378, longitude: 6.0241, country: 'France', region: 'Bourgogne-Franche-Comté' },
  'mulhouse': { latitude: 47.7508, longitude: 7.3359, country: 'France', region: 'Grand Est' },
  'caen': { latitude: 49.1829, longitude: -0.3707, country: 'France', region: 'Normandie' },
  'brest': { latitude: 48.3904, longitude: -4.4861, country: 'France', region: 'Bretagne' },
  'amiens': { latitude: 49.8942, longitude: 2.2958, country: 'France', region: 'Hauts-de-France' },
  'le mans': { latitude: 48.0061, longitude: 0.1996, country: 'France', region: 'Pays de la Loire' },
  'reims': { latitude: 49.2583, longitude: 4.0317, country: 'France', region: 'Grand Est' },
  'annecy': { latitude: 45.8992, longitude: 6.1294, country: 'France', region: 'Auvergne-Rhône-Alpes' },
  'chambéry': { latitude: 45.5646, longitude: 5.9178, country: 'France', region: 'Auvergne-Rhône-Alpes' },
  'chambery': { latitude: 45.5646, longitude: 5.9178, country: 'France', region: 'Auvergne-Rhône-Alpes' },
  'valence': { latitude: 44.9333, longitude: 4.8924, country: 'France', region: 'Auvergne-Rhône-Alpes' },
